...
import { useGetCategoryProducts } from "../../hooks/productHooks/useGetCategoryProducts";
...
function CategoryProducts() {
  ...
  const {
    ...
    page,
    setPage,
  } = useGetCategoryProducts(category);
  console.log(data);
  const totalPageNo = Math.ceil(data?.length / TOTAL_LIMIT);
